...
int main()
{
  ...
  //Escribo el ID del proceso horas
  fd = open("horas.pid", O_WRONLY | O_CREAT | O_TRUNC, S_IRUSR | S_IWUSR | S_IRGRP | S_IROTH);
  write(fd,a,strlen(a));
  close(fd);
